            ...
            <div class="flex justify-between">
                <div>
                    <x-select-input :values="$regions" id="region_id" label="Region" width="200px"
                        wire:model="selected_region" wire:change="updateCountryList" defaultValue="{{ $selected_region }}"/>
                ...
                <div>
                    <x-select-input :values="$countries" id="country_id" label="Country" width="200px"
                        wire:model="selected_country" wire:change="updateCityList" defaultValue="{{ $selected_country }}"/>
