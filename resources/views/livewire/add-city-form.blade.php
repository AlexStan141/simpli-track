<div>
    ...
    <x-text-input id="city" class="setting-text-input w-[450px] mt-2" type="text" name="city" wire:model="cityToAdd"
        required />
    <div class="flex gap-7 items-center">
        <x-select-input class="w-[200px] rounded-[32px]" id="region" label="" :values="$regions"
            wire:model="selected_region_id" defaultValue="{{ $selected_region_id }}" wire:change="update_country_list"></x-select-input>
    ...
    <button wire:click="addCity" class="py-3 px-[93px] bg-loginblue text-white mt-[18px] rounded-[80px]">Save</button>
</div>
