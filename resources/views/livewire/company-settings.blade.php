<div>
    ...
    <form method="POST" wire:submit.prevent="saveRegions()">
        ...
        <div class="mt-[41px] ml-[43px] flex">
            <x-select-input width="96px" class="rounded-[5px]" id="currency"
            label="Default currency" :values="$currencies" wire:model="defaultCurrency"></x-select-input>
        </div>
