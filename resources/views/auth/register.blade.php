...
<x-guest-layout class="pt-[67px] pb-[88px]">
    ...
    <form method="POST" action="{{ route('register') }}" class="mt-[29px]">
        @csrf
        ...
        <div class="gap-[20px] grid grid-cols-2">
            ...
            <div class="mt-4 relative top-[-16px]">
            ...
            <div class="mt-4">
                ...
                <x-text-input id="phone" class="block mt-1 w-full p-[16px] h-[42px] text-[14px] leading-none"
        ...
        <div class="flex flex-col items-center gap-1 mt-4">
            <x-primary-button
                class="mt-[52px] bg-transparent ring-1 ring-white w-[226px] h-[49px] justify-center font-nunito text-[18px]">
                {{ __('Register') }}
            </x-primary-button>
